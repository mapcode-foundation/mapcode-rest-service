...
public class ApiAlphabetsTest {
    ...
    public void checkAlphabetsXml() {
        ...
        final String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><alphabets><total>15</total><alphabet><name>ROMAN</name></alphabet><alphabet><name>GREEK</name></alphabet><alphabet><name>CYRILLIC</name></alphabet><alphabet><name>HEBREW</name></alphabet><alphabet><name>HINDI</name></alphabet><alphabet><name>MALAY</name></alphabet><alphabet><name>GEORGIAN</name></alphabet><alphabet><name>KATAKANA</name></alphabet><alphabet><name>THAI</name></alphabet><alphabet><name>LAO</name></alphabet><alphabet><name>ARMENIAN</name></alphabet><alphabet><name>BENGALI</name></alphabet><alphabet><name>GURMUKHI</name></alphabet><alphabet><name>TIBETAN</name></alphabet><alphabet><name>ARABIC</name></alphabet></alphabets>";
    ...
    public void checkAlphabetsCountXml() {
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><alphabets><total>15</total><alphabet><name>ROMAN</name></alphabet><alphabet><name>GREEK</name></alphabet></alphabets>",
                response.readEntity(String.class));
    }
    ...
    public void checkAlphabetsCountOffsetXml() {
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><alphabets><total>15</total><alphabet><name>GREEK</name></alphabet></alphabets>",
                response.readEntity(String.class));
    }
    ...
    public void checkAlphabetsCountOffsetFromEndXml() {
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><alphabets><total>15</total><alphabet><name>ARABIC</name></alphabet></alphabets>",
                response.readEntity(String.class));
    }
